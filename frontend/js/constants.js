...
const h2_presale_coming_soon = "Orca Minting Countdown";
const h2_presale_mint = "Orca Minting Countdown";
...
const p_presale_mint_already_minted = "Please icrease gas to ensure a successful mint. Check MetaMask if Dapp doesn't update.";
const p_public_mint = "Please icrease gas to ensure a successful mint and please check MetaMask if Dapp doesn't update with your mint.";
const button_presale_coming_soon = "Join theFam";
const button_presale_mint_whitelisted = "Mint Your Orca";
const button_presale_mint_not_whitelisted = "Join theFam";
